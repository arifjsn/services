      ...
      <div class="col-md-6">
        ...
        <div class="box box-solid">
          <div class="box-body">
            ...
            <h3 align="center" style="color: #300104;"><b>Cek Status</b></h3>
              ...
              <div class="row">
                ...
                <div class="col-xs-8">
                  <div class="form-group">
                    ...
                    <p align="left" style="color: #300104;"><b>Masukkan no kode yang tertera pada nota transaksi anda</b></p>
                  </div>

                  <div class="box-footer">
                    <button name="cek" class="btn pull-left" style="background: #300104;color:#fff;">Cek</button>
                  </div>
                  <?php
                  if (isset($_POST['cek'])) {
      ...
      <div class="col-md-6">
        ...
        <div class="box box-solid">
          <div class="box-body">
            ...
            <h3 align="center" style="color: #300104;"><b>Informasi Estimasi Biaya</b></h3>
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-xs-8">
                  ...
                  <div class="form-group">
                    <p align="left" style="color: #300104;"><b>Harga Dapat Berubah </b></p>
                    <br>
                  </div>
