...
class Pelanggan
{
	...
	public function tambah($no_identitas, $nama, $username, $password, $alamat, $no_hp)
	{
		$db = $this->mysqli->conn;
		$db->query("INSERT INTO pelanggan VALUES ('$no_identitas','$nama', '$username', '$password', '$alamat', '$no_hp')") or die($db->error);
	}
